...
@Component({
  selector: 'app-payment-transfer-bank-dialog',
  standalone: true,
  templateUrl: './payment-transfer-bank-dialog.component.html',
  styleUrl: './payment-transfer-bank-dialog.component.css',
  imports: [SharedCommonModule,TableModule,CommonModule]
})
export class PaymentTransferBankDialogComponent implements OnInit{
