...
@Component({
  selector: 'app-payment-transfer-bank-to-bank-dialog',
  standalone: true,
  templateUrl: './payment-transfer-bank-to-bank-dialog.component.html',
  styleUrl: './payment-transfer-bank-to-bank-dialog.component.css',
  imports: [SharedCommonModule,TableModule,CommonModule]
})
export class PaymentTransferBankToBankDialogComponent implements OnInit{
