...
@Component({
  selector: 'app-payment-adjust-bank-dialog',
  standalone: true,
  templateUrl: './payment-adjust-bank-dialog.component.html',
  styleUrl: './payment-adjust-bank-dialog.component.css',
  imports: [SharedCommonModule,TableModule,CommonModule]
})
export class PaymentAdjustBankDialogComponent implements OnInit{
