...
@Component({
  selector: 'app-customer-vendor-payment-dialog',
  standalone: true,
  templateUrl: './customer-vendor-payment-dialog.component.html',
  styleUrl: './customer-vendor-payment-dialog.component.css',
  imports: [SharedCommonModule,TableModule,CommonModule]
})
export class CustomerVendorPaymentDialogComponent implements OnInit{
