...
@Component({
  selector: 'app-customer-opening-balance-dialog',
  standalone: true,
  templateUrl: './customer-opening-balance-dialog.component.html',
  styleUrl: './customer-opening-balance-dialog.component.css',
  imports: [SharedCommonModule,TableModule,CommonModule]
})
export class CustomerOpeningBalanceDialogComponent implements OnInit{
