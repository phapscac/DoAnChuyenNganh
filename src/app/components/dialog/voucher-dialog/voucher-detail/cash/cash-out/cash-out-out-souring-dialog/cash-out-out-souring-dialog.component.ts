...
@Component({
  selector: 'app-cash-out-out-souring-dialog',
  standalone: true,
  templateUrl: './cash-out-out-souring-dialog.component.html',
  styleUrl: './cash-out-out-souring-dialog.component.css',
  imports: [SharedCommonModule,TableModule,CommonModule],
})
export class CashOutOutSouringDialogComponent implements OnInit{
